...
class Apartment(mongoengine.Document): # создания класса для работы с документами для монгоДБ
    ...
    booking = mongoengine.EmbeddedDocumentListField(Booking) # тут мы добавляем класс для работы с классом из booking. для добавления дочерных елементов внутри документа apartments
